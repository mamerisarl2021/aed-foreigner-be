...
<head>
   ...
   <![endif]-->
    <title>Notification d'ajout en tant qu'agent</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Bonjour cher(e) agent(e)!</p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Un compte vient d'être créé pour vous en tant qu'agent sur notre
                                                plateforme.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Utilisez ce lien pour initialiser votre mot de passe et et finaliser
