...
<head>
   ...
   <![endif]-->
    <title>Lien pour poursuivre vos notifications</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Bonjour Mr\Mme {{ $link }} !</p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Vous venez d'éffectuer un paiement pour procéder à votre validation en ligne.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Vous trouverez ci-dessous le lien pour poursuivre le processus.
                                            </p>
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
                                                Merci, <br>AED Quality Corporate</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
