...
<head>
    ...
    <title>Notification de plannification de rendez-vous.</title>
    <link
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Un de nos agents prendra contact avec vous dans les minutes à suivre pour une prise de rendez-vous. Une fois votre compte créé suite à la prise de rendez-vous; vous pourrez connecter et accéder à la panoplie de services que nous mettons à votre disposition via ce lien:
                                            </p>
