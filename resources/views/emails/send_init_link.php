...
<head>
   ...
   <![endif]-->
    <title>Lien de mise à jour</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Bonjour cher(e) utilisateur(trice)!</p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Votre demande d'identité sur la plateforme AED à bien été prise en compte nous vous prions de suivre ce lien pour mettre à jour votre <?php echo htmlspecialchars($type); ?>.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Voici votre lien de mise à jour: </p>
                                            <!-- <div style="font-weight: bold;text-align:center;width:100%;font-size: 20px;">
                                                <a href="<?php echo htmlspecialchars($code); ?>"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 24px; display: block; font-size: 16px; line-height: 100%; color: #225888; text-decoration: none;"><?php echo htmlspecialchars($code); ?></a>
                                            </div> -->
