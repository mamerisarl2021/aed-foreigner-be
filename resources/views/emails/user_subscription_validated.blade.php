                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <a href="https://{{config('trustedx.base_url')}}/trustedx-authserver/oauth/{{config('trustedx.clients_logged_as')}}?redirect_uri={{config('app.frontend_url')}}/bridge-page?type=employee_{{$processId}}&client_id={{config('trustedx.client_id')}}&response_type=code&scope=urn:eidas:sign:identity:register%20urn:gob:server:identities:employee:issue&state=state_secret_491178&ui_locales=fr&register_group_labels=employee,gob,server"
