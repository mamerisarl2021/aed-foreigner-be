...
<head>
   ...
   <![endif]-->
    <title>Souscription validée</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Merci de nous avoir accordé votre confiance pour l'acquisition de votre certificat !
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Utilisez ce lien afin de poursuivre la création de votre certificat!
                                            </p>
                                            <a href="https://{{env('TX_BASE_URL')}}/trustedx-authserver/oauth/{{env('TX_CLIENTS_LOGGED_AS')}}?redirect_uri={{env('FRONTEND_URL')}}/bridge-page?type=employee_{{$processId}}&client_id={{env('TX_CLIENT_ID')}}&response_type=code&scope=urn:eidas:sign:identity:register%20urn:gob:server:identities:employee:issue&state=state_secret_491178&ui_locales=fr&register_group_labels=employee,gob,server"
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 24px; display: block; font-size: 16px; line-height: 100%; color: #225888; text-decoration: none;">{{ env('FRONTEND_URL') }}</a>
                                            <table cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td
                                                        ...
                                                        <a href="https://{{env('TX_BASE_URL')}}/trustedx-authserver/oauth/{{env('TX_CLIENTS_LOGGED_AS')}}?redirect_uri={{env('FRONTEND_URL')}}/bridge-page?type=employee_{{$processId}}&client_id={{env('TX_CLIENT_ID')}}&response_type=code&scope=urn:eidas:sign:identity:register%20urn:gob:server:identities:employee:issue&state=state_secret_491178&ui_locales=fr&register_group_labels=employee,gob,server"
                                                            style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Poursuivre&rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 10 0;">
                                                Si vous n'êtes associé à aucun compte et que vous pensez quil s'agit
                                                d'une erreur nous vous prions de nous contacter via mail à l'adresse
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
                                                Merci, <br>Votre fournisseur d'identité numérique!</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
