...
<head>
   ...
   <![endif]-->
    <title>Souscription crée avec succès</title>
    <link
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <a href="https://{{env('TX_BASE_URL')}}/trustedx-authserver/oauth/{{env('TX_ADMINS_LOGGED_AS')}}?redirect_uri={{env('FRONTEND_URL')}}/bridge-page?type=citizen_{{$processId}}&client_id={{env('TX_CLIENT_ID')}}&response_type=code&scope=urn:eidas:sign:identity:register%20urn:safelayer:eidas:full_identity&view_type=compact&ui_locales=fr&register_group_labels=server,citizen"
