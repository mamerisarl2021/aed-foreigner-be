                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <a href="https://{{config('trustedx.base_url')}}/trustedx-authserver/oauth/{{config('trustedx.admins_logged_as')}}?redirect_uri={{config('app.frontend_url')}}/bridge-page?type=citizen_{{$processId}}&client_id={{config('trustedx.client_id')}}&response_type=code&scope=urn:eidas:sign:identity:register%20urn:safelayer:eidas:full_identity&view_type=compact&ui_locales=fr&register_group_labels=server,citizen"
