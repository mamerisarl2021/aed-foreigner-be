                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="margin: 0 0 24px;">
                                                <strong>{{ $inviterName }}</strong> vous invite à signer le document intitulé :
                                            ...
                                            <table style="width: 100%; text-align: center; margin-bottom: 24px;" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td>
                                                        <a href="{{ $signatureLink }}" style="display: inline-block; padding: 12px 24px; font-size: 16px; font-weight: 600; color: #ffffff; background-color: #225888; text-decoration: none; border-radius: 4px;">
                                                            Signer le document
                                                        </a>
                                                    </td>
                                                </tr>
