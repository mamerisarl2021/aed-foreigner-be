...
<body
    ...
    <div role="article" aria-roledescription="email" aria-label="Document refusé" lang="fr"
                    ...
                    <table class="sm-w-full" style="width: 600px;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                            <td class="sm-py-32 sm-px-24"
                                ...
                                <a href="https://votre-plateforme.com"
                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                    <img src="" width="155" alt="Votre Logo"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Nous vous informons que le document suivant a été refusé :
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px; font-weight: bold;">
                                            ...
                                            <p
                                                ...
                                                Rejeté par : {{ $rejecterName }}
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Nous vous invitons à prendre les mesures nécessaires pour remédier à cette situation.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
                                                Merci de votre compréhension,<br>L’équipe Support.
                                            </p>
                                            ...
                                            <p
                                                ...
                                                <a href="mailto:support@votre-plateforme.com" class="hover-underline"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #225888; text-decoration: none;">support@votre-plateforme.com</a>.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
