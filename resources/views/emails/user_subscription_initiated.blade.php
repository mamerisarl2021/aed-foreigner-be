...
<head>
   ...
   <![endif]-->
    <title>Souscription initiée</title>
    <link
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Votre demande a bien été enregistrée et est actuellement en cours de traitement. Vous recevrez un e-mail de notre part dès que le processus sera finalisé.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 10 0;">
                                                Si vous n'êtes pas à l'origine de cette demande ou si vous pensez qu'il s'agit d'une erreur, nous vous prions de bien vouloir nous contacter rapidement à l'adresse suivante :
