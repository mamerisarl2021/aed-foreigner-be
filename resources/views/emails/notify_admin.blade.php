...
<head>
   ...
   <![endif]-->
    <title>OTP de vérification</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Dans le cadre de la validation de la création d'un compte entreprise sur la plateforme d'enregistrement déléguée de Quality
                                                Corporate, un code OTP vous est envoyé dans ce mail afin de finaliser l'activation de votre entreprise.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Voici votre code: </p>
                                            ...
                                            <p
                                                ...
                                                Si vous n'avez pas initié le processus de création et vous pensez quil s'agit
