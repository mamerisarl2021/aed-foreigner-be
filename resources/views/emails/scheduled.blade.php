...
<head>
    ...
    <title>Notification de validation de rendez-vous.</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Votre demande de vérification face à face pour la création d'une identité de type avancée à bien été reçue et approuvée.
                                            </p>
                                            <p>Date proposée : {{ \Carbon\Carbon::parse($data['date'])->format('d/m/Y H:i') }}</p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 10 0;">
                                                Si cette date ne vous convient plus, veuillez nous contacter.
