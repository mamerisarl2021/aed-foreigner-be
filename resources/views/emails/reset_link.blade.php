...
<head>
   ...
   <![endif]-->
    <title>Lien de mise à jour du mot de passe</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Vous venez d'éffectuer une de mise à jour de votre mot de passe.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Vous trouverez ci-dessous le lien de mise à jour de votre mot de passe.
                                            </p>
                                            <a href="{{ $link }}"
