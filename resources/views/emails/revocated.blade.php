...
<head>
   ...
   <![endif]-->
    <title>Demande de révocation traitée</title>
    <link
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Votre demande de révocation de certificat numérique vient d'être traitée par nos agents.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
                                                Merci de nous faire confiance, <br>l'équipe d'enregistrement déléguée</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
