...
return [
    ...
    'service_name' => env('CONSUL_SERVICE_NAME', env('SERVICE_NAME', 'portal-id-foreigner')),
    'service_ip' => env('CONSUL_SERVICE_IP', env('SERVICE_IP')),
    'service_port' => (int) env('CONSUL_SERVICE_PORT', env('SERVICE_PORT', 8000)),
    ...
    'deregister_after' => env('CONSUL_DEREGISTER_AFTER', '1m'),
